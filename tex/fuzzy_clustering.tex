...
\subsection{\fontencoding{OT2}\selectfont Na\v{s}a implementacija}
...
\item $p$ - ceo broj koji ozna\v{c}ava paramear za {\fontencoding{T1}\selectfont fuzzy} formulu kojom odredjujemo verovatnocu pripadnosti nekog podatka za svaki od klastera;
